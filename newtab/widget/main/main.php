...
<div id="main">
    <div class="nav-header clearfix">
        <ul class="nav-header-menu">
            <li class="active">
                <a href="javascript:void(0);">我的站点</a>
            </li>
        </ul>
    </div>
        ...
        <div class="dialog-body">
            <article id="grid_list" class="clearfix">
                ...
                <div class="grid-search">
                    <input id="grid_search_btn" name="" type="input" placeholder="请输入URL" />
            ...
            <article class="dialog-custome-add clearfix" style="display:none;">
                <div class="dialog-input clearfix">
                    <input name="title" type="input" class="input fl" placeholder="请输入标题" style="width: 30%;margin-left: 0px;margin-right: 2px;"/>
                    <input name="url" type="input" class="input fr" placeholder="请输入标题*" autocomplete="off" />
                    <p class="error"><em>icon</em><span>请输入标题</span></p>
                </div>
                <div class="dialog-input clearfix">
                    <ul class="tab">
                        <li class="hover" title="当前打开">当前打开</li>
                        <li title="经常访问">经常访问</li>
                        <li title="傲游笔记">傲游笔记</li>
                        <li title="上次未关闭">上次未关闭</li>
                    </ul>
                    <div class="main-warp">
                        <div class="main"></div>
                ...
                <div class="dialog-input clearfix">
                    <div class="radio-list">
                        <label for="recommendlogo" title="推荐图片">推荐图片</label>
                    </div>
                    <div class="radio-list selected">
                        <label for="screenshot" title="截图">网页截图</label>
                    </div>
                    <div class="radio-list">
                        <label for="colorblock" title="色块">色块文字</label>
                    </div>
