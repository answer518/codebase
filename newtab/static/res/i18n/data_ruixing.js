...
var DEFAULT_MY_SITE = [
	...
	{
		"folderId": typeof guid === 'function' ? guid() : '0495ed3e-e5e6-ee18-1d8f-0ef3e68c5c44',
		"title": "新闻资讯",
		"children": [
			{
				'title': '凤凰网',
	...
	{
		"folderId": typeof guid === 'function' ? guid() : 'f7b4e480-7325-d6c3-b977-763708a8c8b6',
		"title": "网上购物",
		"children": [
			{
				'title': '1号店',
	...
	{ 'title': '百度', 'url': 'https://www.baidu.com/index.php?tn=maxthon2&ch=10', 'image': staticServer + '/v1.1/image/logo/Sq/baidu.png', isHot: true },
	{ 'title': '天猫精选', 'url': 'http://go.maxthon.cn/redir/mx5/qa.htm?f=tmall', 'image': staticServer + '/v1.1/image/logo/Sq/Tmall.png', isHot: true },
	{ 'title': '京东商城', 'url': 'http://go.maxthon.cn/redir/mx5/qa.htm?f=jd', 'image': staticServer + '/v1.1/image/logo/Sq/JD.png', isHot: true },
	{ 'title': '爱淘宝', 'url': 'http://go.maxthon.cn/redir/mx5/qa.htm?f=aitaobao', 'image': staticServer + '/v1.1/image/logo/Sq/simba_taobao.png', isHot: true },
	{ 'title': '淘宝专享优惠券', 'url': 'https://maxthon.walatao.com/?from=rising', 'image': staticServer + '/v1.1/image/logo/Sq/walatao.png', isHot: true },
	{ 'title': '携程旅行网', 'url': 'http://go.maxthon.cn/redir/mx5/qa.htm?f=ctrip', 'image': staticServer + '/v1.1/image/logo/Sq/ctrip.png', isHot: true },
	{ 'title': '优酷', 'url': 'http://www.youku.com/', 'image': staticServer + '/v1.1/image/logo/Sq/youku.png', isHot: true },
	{ 'title': '傲游今日', 'url': 'http://i.maxthon.cn/', 'image': staticServer + '/v1.1/image/logo/Sq/i_maxthon.png', isHot: true },
]
...
var SITE_LIST = [{
	'categroy': '推荐站点',
	'list': [{ 'title': '百度', 'url': 'https://www.baidu.com/index.php?tn=maxthon2&ch=10', 'match': ['www.baidu.com'], 'image': staticServer + '/v1.1/image/logo/Re/baidu.png' },
	...
	{ 'title': '淘宝专享优惠券', 'url': 'https://maxthon.walatao.com/?from=rising', 'image': staticServer + '/v1.1/image/logo/Re/walatao.png' },
